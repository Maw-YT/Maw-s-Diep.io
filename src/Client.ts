...
import TankDefinitions, { getTankById, TankCount, TankDefinition } from "./Const/TankDefinitions";
...
export default class Client {
    ...
    /** Custom tank definition, if any. */
    public customTankDefinition: TankDefinition | null = null;

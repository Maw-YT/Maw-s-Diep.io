 ...
 */
export default class AutoSTurret extends ObjectEntity {
    // TODO(ABC):
    ...
    public constructor(owner: BarrelBase, turretDefinition: BarrelDefinition = AutoTurretDefinition, baseSize: number = 25) {
        ...
        let BaseTurrentSize = 85;
        let BaseTurretDelay = 0;

        for (let i = 0; i < 5; ++i) {
            this.turret.push(new Barrel(this, {
                ...turretDefinition,
                size: BaseTurrentSize - (i * 5),
                delay: BaseTurretDelay + (i * 0.2)
            }));
        }

...
app.listen(PORT, (success) => {
    ...
    const mts = new GameServer("mot", "Mothership");
    const team2 = new GameServer("teams", "2 Teams");
    // const tag = new GameServer("tag", "Tag");
    // const dom = new GameServer("dom", "Domination");
    // commented out gamemodes are for performance reasons.
    
    games.push(ffa, maze, team2, mts);
